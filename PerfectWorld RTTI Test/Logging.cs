    ...
    public static class Logging {
        ...
        public static void Log(string msg) {
            if (useCtrl) {
                ...
                if (ctrl != null) Invoke(() => ctrl.AppendText(msg));
                else throw new ApplicationException("Logging Error: Log Control is null");
            } else {
        ...
        public static void Clear() {
            if (useCtrl) {
                var ctrl = LogControl as RichTextBox;
                if (ctrl != null) Invoke(() => ctrl.Clear());
                else throw new ApplicationException("Logging Error: Log Control is null");
            } else {
                Console.Clear();
            }
        ...
        private static void Invoke(Action method) {
            try {
                if (LogControl.InvokeRequired) LogControl.Invoke(method);
                else method();
            } catch (Exception ex) {
